...
$${\color{red}\text{Example}}$$: For graphene calculations with 6 decimals ($10^{-6}$ eV), modify line 635
```bash
...
$${\color{red}\text{Example}}$$: For graphene calculations with 6 decimals
```bash
